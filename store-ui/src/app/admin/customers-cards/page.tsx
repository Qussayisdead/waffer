...
export default function CustomersCardsPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="glass rounded-2xl border border-white/60 p-6">
        <h2 className="mb-4 text-lg font-semibold text-night">{t("cards.issue")}</h2>
      ...
      {cardResult && (
        <div className="mt-4 rounded-xl border border-white/60 bg-white/60 p-4 text-sm text-night">
            <div>
            ...
            {qrPng && (
              <div className="mt-4 flex flex-col gap-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <a
                    className="rounded-2xl border border-night/20 px-4 py-2 text-sm text-night hover:border-emerald-300"
                    href={qrPng}
      ...
      <div className="space-y-3">
        <h2 className="text-lg font-semibold text-night">{t("cards.title")}</h2>
        <label className="block max-w-sm space-y-2 text-sm">
          <span className="text-night/70">{t("cards.filterStore")}</span>
          <select
