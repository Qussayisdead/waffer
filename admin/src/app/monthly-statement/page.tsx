      ...
      <div className="glass rounded-2xl border border-white/60 p-6">
        <div className="grid gap-4 md:grid-cols-3">
          <label className="block space-y-2 text-sm">
            <span className="text-dusk/80">{t("reports.storeLabel")}</span>
            <select
          ...
          <label className="block space-y-2 text-sm">
            <span className="text-dusk/80">{t("reports.monthLabel")}</span>
            <input
              className="w-full rounded-xl border border-dusk/20 bg-white/80 px-4 py-3 text-ink outline-none focus:border-clay/60"
              value={form.month}
          ...
          <label className="block space-y-2 text-sm">
            <span className="text-dusk/80">{t("reports.yearLabel")}</span>
            <input
              className="w-full rounded-xl border border-dusk/20 bg-white/80 px-4 py-3 text-ink outline-none focus:border-clay/60"
              value={form.year}
        ...
        <div className="space-y-6">
          <div className="grid gap-4 md:grid-cols-3">
            <div className="glass rounded-2xl border border-white/60 p-4">
              <div className="text-xs text-dusk/70">{t("reports.subtotal")}</div>
              <div className="mt-2 text-lg font-semibold text-ink">
                {statement.summary.subtotal.toFixed(2)} {currencySymbol}
              </div>
            </div>
            <div className="glass rounded-2xl border border-white/60 p-4">
              <div className="text-xs text-dusk/70">{t("reports.discounts")}</div>
              <div className="mt-2 text-lg font-semibold text-ink">
                {statement.summary.discountsGiven.toFixed(2)} {currencySymbol}
              </div>
            </div>
            <div className="glass rounded-2xl border border-white/60 p-4">
              <div className="text-xs text-dusk/70">{t("reports.sales")}</div>
              <div className="mt-2 text-lg font-semibold text-ink">
                {statement.summary.totalSales.toFixed(2)} {currencySymbol}
              </div>
            </div>
            <div className="glass rounded-2xl border border-white/60 p-4">
              <div className="text-xs text-dusk/70">{t("reports.invoiceCount")}</div>
              <div className="mt-2 text-lg font-semibold text-ink">
                {statement.summary.invoiceCount}
              </div>
            </div>
            <div className="glass rounded-2xl border border-white/60 p-4">
              <div className="text-xs text-dusk/70">{t("reports.averageTicket")}</div>
              <div className="mt-2 text-lg font-semibold text-ink">
                {statement.summary.averageTicket.toFixed(2)} {currencySymbol}
              </div>
            </div>
            <div className="glass rounded-2xl border border-white/60 p-4">
              <div className="text-xs text-dusk/70">{t("reports.averageDiscountPercent")}</div>
              <div className="mt-2 text-lg font-semibold text-ink">
          ...
          <div>
            <h2 className="mb-3 text-lg font-semibold text-ink">{t("reports.dailyBreakdown")}</h2>
            <DataTable
              columns={[
